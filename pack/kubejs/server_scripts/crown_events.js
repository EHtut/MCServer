// crown_events.js - what The False King sends.
//
...
;(function () {
  ...
  var ACTOR = 'born_in_chaos_v1:missioner'
  var ACTOR_TAG = 'veldora_crown_actor'
  ...
  function evExample(server, p) {
    // TODO(ethan): what does The False King actually do here?
  ...
  ServerEvents.loaded(function (event) {
    ...
    if (!voiceIsWritten()) {
      console.warn(TAG + 'HELD - The False King has no written lines yet, so nothing is ' +
        'registered. A walker on this path would have drawn silent placeholder ' +
        'events. Fill the pools in crown_voice.js and restart; this arms itself.')
      return
    }
    ...
    console.info(TAG + 'The False King sends: example, quiet, guarded - SKELETON, ' +
