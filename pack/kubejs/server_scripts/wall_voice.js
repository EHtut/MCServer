...
;(function () {
  ...
  var LINES = {
    ...
    //
    // ⭐⭐ AND THE GRIEF HAS A SOURCE NOW (LORE.md > Mera §2). Wall is MERA: built and hyped her
    ...
    // them knows (LORE.md > Mera §1). Do not hint. See the matching note in blade_voice.js.
    // ═══════════════════════════════════════════════════════════════════════
