...
RULES = [
    ...
    ('biomes', r'oh-the-biomes|yungs-cave-biomes|biolith|terrablender|lithostitched|frostiful|scorchful|serene-seasons|thermoo|nether-depths|infernal-expansion|formations-nether|galosphere'),
