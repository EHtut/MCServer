> ⛔ **ARCHIVED 2026-09-05 — FICTION UNLESS RE-VERIFIED.** Its subject is spent: Title says NOT BUILT but tide.js, waves.js, bicker.js and bicker_scenes.js all ship, 68-THE-GAMEPLAN marks D1–D6 done, tuning has moved to 71 and 74, and §1's blocker is diagnosed and fixed in 64-THE-DEPTH.
>
> **HOLDS (why this was archived and not deleted):** Ethan's verbatim Darktide/Vermintide brief and the Bickering request; the "a wave is an ARRIVAL, not a drop" ruling and the 2026-08-18 cadence/herald ruling (both already copied into tide.js's header); the Lootr [refresh] values applied 2026-08-24 to instance/config/lootr-common.toml with the 6000-tick reasoning, which I found recorded nowhere else.
>
> ⚠️ **KNOWN STALE:** Title "(design, 2026-08-18, NOT BUILT)"; §1's measured "everything below y−64 is 100% air" is superseded by 64, which diagnosed, fixed and verified it on a generated world.
>
