...
> back is fine too.
>
> Generated 2026-08-30 11:29 from `pack/kubejs/server_scripts/wall_voice.js` by RUNNING it, so every line
...
**187 whole lines** across 38 tags · **7 fragment tags** making **624** combined lines · **11 systems**.

---

# wall_events.js

*also referenced in `art_events.js`, `blade_events.js`, `salvage_events.js`, `voice.js`*
...
*also referenced in `_probe_patron.js`, `arrival.js`, `art_voice.js`, `blade_events.js`, `blade_voice.js`, `chosen.js`, `counter_hooks.js`, `counters.js`, `deep_speaker.js`, `idle.js`, `pathless.js`, `patron_sound.js`, `salvage_events.js`, `tide.js`, `voice.js`*
...
*also referenced in `_probe_patron.js`, `arrival.js`, `chosen.js`, `counters.js`, `deep_speaker.js`, `pathless.js`, `paths.js`, `patron_sound.js`, `reckoning.js`, `salvage.js`, `salvage_deals.js`, `salvage_voice.js`, `voice.js`*
...
*high_hostile - from `blade_events.js` (`tier === 'high' ? 'high_test' : (tier === 'medium' ? 'medium_test' : '`), `blade_voice.js` (`t + (t === 'high' ? '_test' : '_gift')`)*
