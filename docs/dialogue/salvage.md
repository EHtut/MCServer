...
>
> Generated 2026-08-30 11:10 from `pack/kubejs/server_scripts/salvage_voice.js` by RUNNING it, so every line
...
rule the engine cannot check for you: with 60 opens and 60 closes a tag makes
560 different lines, and every one of them has to work.
...
**192 whole lines** across 52 tags · **120 fragments** across 8 tags, making **560** possible combined lines.
