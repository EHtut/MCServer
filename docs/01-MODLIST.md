...
| Mod | Version | Side | Tier | Why |
|---|---|---|---|---|
| [Apothic Attributes](https://modrinth.com/mod/apothic-attributes) | `1.21.1-2.10.1` | both | core | Attribute backend for Apotheosis |
...
| [Ars Ocultas](https://modrinth.com/mod/ars-ocultas) | `1.21.1-2.5.0` | both | minor | Ars integration for Occultism |
| [Ars Polymorphia](https://modrinth.com/mod/ars-polymorphia) | `1.0.3` | both | minor | Polymorph support for Ars storage lecterns |
| [Ars Structurize](https://modrinth.com/mod/ars-structurize) | `1.1.3` *beta* | both | minor | Ars-themed structures in worldgen |
| [Ars Technic](https://modrinth.com/mod/ars-technic) | `0.1.0` | both | minor | Ars tech-leaning addon |
...
| [Cataclysm: Spellbooks](https://modrinth.com/mod/cataclysm-spellbooks) | `1.1.11-1.21` | both | minor | Bridges Cataclysm bosses to Iron's Spells |
| [Charm of Undying](https://modrinth.com/mod/charm-of-undying) | `9.1.0+1.21.1` | both | minor | Totem in an accessory slot |
| [Dis-Enchanting Table](https://modrinth.com/mod/dis-enchanting-table) | `5.0.2` | both | minor | Recover enchantments instead of wasting them |
...
| [Crimson Curse: Infection](https://modrinth.com/mod/crimson_curse) | `1.4.3.1+mod` *beta* | both | major | A Nether-born virus that escapes into the Overworld and spreads |
| [CRYPTID](https://modrinth.com/mod/cryptid) | `1.1.0.2+mod` | both | major | 40 cryptids and 50 world events. The single largest horror content mod available |
| [Deeper and Darker](https://modrinth.com/mod/deeperdarker) | `1.4.1-neoforge-1.21.1` | both | major | Deep Dark expansion - the warden's world made larger |
| [Distant Friends](https://modrinth.com/mod/distant-friends) | `0.9.5` | both | major | Player-like figures that watch from a distance and never approach |
...
| [Revervox](https://modrinth.com/mod/revervox) | `2.0` | both | major | Records and replays your friends' actual voices back at you. With proximity voice chat, the most effective horror mod in the pack |
...
| [Shadow of the Soul](https://modrinth.com/mod/shadow-of-the-soul) | `1.0` | both | major | A Fear Level system that reacts to player behaviour. Explicitly stateful, and a natural DM input |
...
| [The Skinwalker Hunt](https://modrinth.com/mod/the-skinwalker-hunt) | `6.0` | both | major | A skinwalker that impersonates other mobs |
| [Doctor Who: Weeping Angels](https://modrinth.com/mod/weeping-angels) | `neoforge-1.0.4` | both | major | Do not blink, do not look away |
| [Whispering Spirits](https://modrinth.com/mod/whispering-spirits) | `1.4.0` | both | major | Atmospheric spirits - ambient dread rather than a monster |
| [Zombie Awareness](https://modrinth.com/mod/zombie-awareness) | `1.21.0-1.13.2` | both | major | Zombies track by blood scent, sound and light. Makes ordinary nights tense |
| [Abandoned Watchtowers](https://modrinth.com/mod/abandoned-watchtowers) | `7.0` | both | minor | Abandoned watchtowers in forests - atmosphere in worldgen |
...
| [YUNG's Better Jungle Temples](https://modrinth.com/mod/yungs-better-jungle-temples) | `1.21.1-NeoForge-3.1.2` | server | major | Jungle temple overhaul |
...
| [YUNG's Better Nether Fortresses](https://modrinth.com/mod/yungs-better-nether-fortresses) | `1.21.1-NeoForge-3.1.5` | server | major | Nether fortress overhaul |
| [YUNG's Better Ocean Monuments](https://modrinth.com/mod/yungs-better-ocean-monuments) | `1.21.1-NeoForge-4.1.2` | server | major | Ocean monument overhaul |
...
| [Macaw's Doors](https://modrinth.com/mod/macaws-doors) | `1.1.5` | both | minor | Doors |
| [Macaw's Fences and Walls](https://modrinth.com/mod/macaws-fences-and-walls) | `1.2.1` | both | minor | Fences and walls |
| [Macaw's Furniture](https://modrinth.com/mod/macaws-furniture) | `3.4.1` | both | minor | Furniture |
| [Macaw's Lights and Lamps](https://modrinth.com/mod/macaws-lights-and-lamps) | `1.1.5` | both | minor | Lights |
| [Macaw's Paths and Pavings](https://modrinth.com/mod/macaws-paths-and-pavings) | `1.1.1` | both | minor | Paths |
| [Macaw's Roofs](https://modrinth.com/mod/macaws-roofs) | `2.3.2` | both | minor | Roofs |
| [Macaw's Stairs](https://modrinth.com/mod/macaws-stairs) | `1.0.2` | both | minor | Stairs |
| [Macaw's Trapdoors](https://modrinth.com/mod/macaws-trapdoors) | `1.1.5` | both | minor | Trapdoors |
...
| Mod | Version | Side | Tier | Why |
|---|---|---|---|---|
| [Bountiful Fares](https://modrinth.com/mod/bountiful-fares) | `3.0.11` | both | major | Broad food and farming expansion |
| [Farmer's Delight](https://modrinth.com/mod/farmers-delight) | `1.21.1-1.3.2` | both | major | The cooking and farming base |
| [Animal Feeding Trough](https://modrinth.com/mod/animal_feeding_trough) | `1.1.2+1.21(.1)-neoforge` | both | minor | Animals feed themselves |
| [Butchery](https://modrinth.com/mod/butchery) | `5.2` | both | minor | Immersive mob harvesting - quietly grim, which suits the server |
...
| Mod | Version | Side | Tier | Why |
|---|---|---|---|---|
| [Accessories](https://modrinth.com/mod/accessories) | `1.1.0-beta.53+1.21.1` *beta* | both | core | The other accessory API; several 1.21.1 mods moved to it |
| [Accessories Compatibility Layer](https://modrinth.com/mod/accessories-compat-layer) | `0.1.12` *beta* | both | core | Unifies Curios and Accessories so both families coexist |
...
| [AzureLib](https://modrinth.com/mod/azurelib) | `3.1.11` | both | core | Animation library several gun and mob mods need |
...
| [Collective](https://modrinth.com/mod/collective) | `1.21.1-8.39-fabric+forge+neo` | both | core | Serilum's shared library |
| [CorgiLib](https://modrinth.com/mod/corgilib) | `1.21.1-5.0.0.9-NeoForge` | both | core | Library for several worldgen and mob mods |
...
| [Library Ferret](https://modrinth.com/mod/library-ferret) | `4.0.0` | both | core | jtorleon's shared code |
...
| [JamLib](https://modrinth.com/mod/jamlib) | `1.3.6+1.21.1` | both | minor | Small shared library |
| [Konkrete](https://modrinth.com/mod/konkrete) | `1.9.9-1.21-neoforge` | both | minor | Menu and UI library |
...
| Mod | Version | Side | Tier | Why |
|---|---|---|---|---|
| [Ace's Spell Utils](https://modrinth.com/mod/aces-spell-utils) | `1.2.7.1-1.21.1` | both | core | Required by cataclysm-spellbooks |
| [Apothic-Enchanting](https://modrinth.com/mod/apothic-enchanting) | `1.21.1-1.6.0` | both | core | Required by apotheosis |
| [Apothic-Spawners](https://modrinth.com/mod/apothic-spawners) | `1.21.1-1.4.0` | both | core | Required by apotheosis |
...
| [Citadel (Unofficial Port)](https://modrinth.com/mod/citadel-(1.21.1-port)) | `2.7.6` | both | core | Required by the Alex's Mobs community port |
| [Cobweb](https://modrinth.com/mod/cobweb) | `1.4.0` | both | core | Required by soul-fire-d |
| [CoroUtil](https://modrinth.com/mod/coroutil) | `1.21.0-1.3.8` | both | core | Required by zombie-awareness |
...
| [Cucumber Library](https://modrinth.com/mod/cucumber) | `8.0.16` | both | core | Required by iron-jetpacks, mystical-agriculture |
