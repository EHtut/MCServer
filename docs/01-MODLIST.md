...
| [Tectonic](https://modrinth.com/mod/tectonic) | `3.0.26-neoforge-21.1` | both | major | Bigger mountains, deeper caves - Ethan's ask. Needs lithostitched, already present. WARNING: overrides minecraft:overworld noise settings, collides with mcserver_depth - see docs/archive/16-THE-REFORGE.md D1 |
